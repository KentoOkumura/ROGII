...
- `.steering/20260624-exp118-same-typewell-other-horizontal-prefix-gr-transfer-audit/` を作成した。その後、既存 exp118 との番号衝突を確認し、`.steering/20260624-exp119-same-typewell-other-horizontal-prefix-gr-transfer-audit/` に改番した。
