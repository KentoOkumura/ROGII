...
- `.steering/20260722-exp347-prefix-gr-unary-batched-window-exact-ssm/`と`experiments/exp347_prefix_gr_unary_batched_window_exact_ssm/`が存在し、仮説、単一変更、段階gate、禁止事項、再現性、実行量が記録されている。
