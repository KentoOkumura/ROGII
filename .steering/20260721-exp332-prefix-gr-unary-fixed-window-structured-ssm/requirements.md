...
- `.steering/20260721-exp332-prefix-gr-unary-fixed-window-structured-ssm/`にwindow manifest、boundary supervision、数理objective、計算量、full-well評価、Stage A/B/Cが固定されている。
