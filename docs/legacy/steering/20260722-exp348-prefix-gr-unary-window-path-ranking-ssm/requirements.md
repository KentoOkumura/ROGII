...
- `docs/legacy/steering/20260722-exp348-prefix-gr-unary-window-path-ranking-ssm/`と`experiments/exp348_prefix_gr_unary_window_path_ranking_ssm/`が存在し、仮説、path bank、loss、段階gate、禁止事項、実行量が記録されている。
