...
- `docs/legacy/steering/`、`experiments/exp209.../config.yaml`、train/inference notebook source、helper、`SESSION_NOTES.md`、`result.md`、`metrics.json` が exp209 として整備されている。
