...
- `docs/legacy/steering/20260722-exp349-exp287-u-boundary-continuity-fade/`と`experiments/exp349_exp287_u_boundary_continuity_fade/`が存在し、仮説、式、入力境界、gate、禁止事項、実行量が記録されている。
