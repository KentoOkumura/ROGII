...
os.environ["ROGII_DISABLE_GUARDED_OVERRIDE"] = "1"
...
try:
    if _ov_os.environ.get("ROGII_DISABLE_GUARDED_OVERRIDE", "0") == "1":
        raise RuntimeError("disabled by ROGII_DISABLE_GUARDED_OVERRIDE")
