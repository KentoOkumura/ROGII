---
title: HMM・PF・exp226のwell別失敗パターン監査
date: 2026-07-12
types:
  - oof_analysis
  - comparison
...
topics:
  ...
  - well
status: final
summary: "HMM、PF、exp226のwell別失敗を比較し、whole-well offset、長いtail、GR・geometryの役割差と候補併用条件を整理した。"
---
...
- PF map: `studies/pf_beam_disagreement_error_map/pf_beam_disagreement_well_map.csv`
- typewell / XY: `studies/typewell_position_groups/native_overlap_1_well_position_typewell_summary.csv`
