...
- 2026-06-16: exp068_equivalent_pixiux_inference_port はユーザー指示により破棄。CV-only train v4 と invalid ref `53654439` は履歴として残し、修正版 Kaggle rerun は行わない。代替として当時ルートにあった`KAGGLE_DIRECTION.md`にbacklog `exp073_exp039_cv_reassessment`を追加し、元バックログの対象だけをexp063からexp073に差し替えた。
