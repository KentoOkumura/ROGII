# monotone_or_shape_constrained_lgbm

- 候補名: `monotone_or_shape_constrained_lgbm`
- 状態: `検討メモ・設計不可`
- 対応する上位仮説: `未整理`
- 作成日: 2026-08-12
- 最終更新日: 2026-08-12
- 依頼原文: 旧 `KAGGLE_DIRECTION.md` の未着手表にあった記録を、内容を補完せず個別ファイルへ移行する。
- 期待する成果: `monotone_or_shape_constrained_lgbm`: monotone / shape constrained LGBM を小さく試す
...
- 移行前のアイデア: `monotone_or_shape_constrained_lgbm`: monotone / shape constrained LGBM を小さく試す
- 仮説が正しい場合に期待する観測: 未整理
- 仮説を棄却する観測: 未整理
...
- 先行条件 / 依存: exp092 / pseudo-tail branch の feature monotonicity 仮説
- 変更するもの: 未整理
- 固定するもの: 未整理
...
monotone constraints を少数 feature に限定し、CV と feature importance を比較する
...
制約で mid-bucket が悪化しやすい。大規模探索はしない
