...
def render_markdown(
    ...
    lines = [
        ...
        "",
        "```bash",
        "python3 .agents/skills/kaggle-notebook-fetch/scripts/fetch_top_notebooks.py "
        "--competition rogii-wellbore-geology-prediction --limit 20 "
        ...
        "uv run python scripts/public_notebook_catchup.py --as-of "
        f"{as_of}",
        "```",
        "",
        "## Replay Queue",
