...
def run_joint_generation() -> dict[str, Any]:
    ...
    if bool(execution.get("run_direct_comparison", True)):
        ...
        comparison_summary = run_direct_comparison(
            ...
            baseline_source="in_memory_exp072_full_cache_generated_by_exp225" if use_in_memory_exp072 else None,
        )
    ...
    output_path = paths.artifacts_dir / "exp225_state_known_tvt_self_gr_hmm_emission_summary.json"
    summary = {
        "experiment": paths.experiment_name,
        "status": "state_known_tvt_self_gr_hmm_emission_completed_pending_review",
