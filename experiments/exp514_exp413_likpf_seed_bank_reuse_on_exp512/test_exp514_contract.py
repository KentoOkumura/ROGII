...
GENERATOR = ROOT / "scripts/prepare_exp514_shared_likpf_candidate.py"
STAGE_B_GENERATOR = ROOT / "scripts/prepare_exp514_stage_b_fixed32.py"
STAGE_D_SOURCE = (
    HERE / "exp514_exp413_likpf_seed_bank_reuse_on_exp512_stage_d_visible.py"
)
STAGE_D_GENERATOR = ROOT / "scripts/prepare_exp514_stage_d_visible.py"
PARENT = (
    ROOT
