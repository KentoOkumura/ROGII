...
OUTPUT_PREFIX = "compact_tracker_surface_audit"
...
def run_reproducibility_guard(
    *,
    ...
    manifest = {
        "experiment": "exp074_compact_tracker_surface_lgbm_candidate_audit",
        "parent": "exp063_ravaghi_vs_pixiux_lgbm_feature_parity_audit",
        "mode": "compact_tracker_surface_lgbm_candidate_audit_from_saved_tracker_features",
...
def run_saved_model_inference(
    *,
    ...
    summary = {
        ...
        "mode": "saved_lgb_booster_inference_from_compact_surface_train",
