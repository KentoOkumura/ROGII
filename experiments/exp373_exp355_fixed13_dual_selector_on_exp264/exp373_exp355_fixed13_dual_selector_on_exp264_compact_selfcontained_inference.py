# %% [markdown]
# # exp373 exp355 fixed13 dual selector on exp264 — inference
#
...
def find_config() -> Path:
    ...
    if len(matches) == 1:
        return matches[0]
    raise FileNotFoundError("exp373 config.yaml did not resolve")
...
# %%
raise RuntimeError(
    "exp373 inference is disabled: Stage C must pass, then the fixed13 "
