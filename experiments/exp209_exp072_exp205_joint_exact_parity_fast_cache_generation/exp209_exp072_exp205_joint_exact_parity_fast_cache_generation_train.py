...
# ---
# %% [markdown]
# # exp209 exp072 exp205 joint exact parity fast cache generation train
...
# 5. Joint exp072 / exp205 cache generation
# 6. Metrics, parity, and generated artifacts
...
def write_metrics(paths: ExperimentPaths, summary: dict[str, Any]) -> None:
    ...
    metrics = {
        ...
        "metric": "wall_time_and_exact_feature_parity",
        "cv": best.get("rmse"),
        "public_lb": None,
        "private_lb": None,
        "best_candidate": best,
        ...
        "metric_parity": summary.get("metric_parity"),
        "reference_parity": summary.get("parity"),
...
print_json(
    "cost guard",
    {
        ...
        "exp072_n_jobs": exp072_cache.get("n_jobs"),
        "exp072_pf_seeds": exp072_cache.get("pf_seeds"),
        "exp072_pf_particles": exp072_cache.get("pf_particles"),
