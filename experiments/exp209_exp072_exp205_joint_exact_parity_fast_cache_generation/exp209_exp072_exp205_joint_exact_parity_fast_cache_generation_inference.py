...
# ---
# %% [markdown]
# # exp209 exp072 exp205 joint exact parity fast cache generation inference
...
if inference.get("mode") != "not_applicable_train_feature_cache_only":
    raise ValueError("exp209 inference notebook is only valid for train-feature-cache-only mode")

print(
    "exp209 intentionally does not generate raw-test features, predictions, "
