...
- `tests/test_exp423_same_typewell_gr_dtw_truth_warp_transfer_readout.py`
...
.venv/bin/ruff check experiments/exp423_same_typewell_gr_dtw_truth_warp_transfer_readout/exp423_same_typewell_gr_dtw_truth_warp_transfer_readout_compact_selfcontained_train.py tests/test_exp423_same_typewell_gr_dtw_truth_warp_transfer_readout.py --select F821
.venv/bin/pytest -q tests/test_exp423_same_typewell_gr_dtw_truth_warp_transfer_readout.py
