# %% [markdown]
# # exp497 Stage M — outer fold 2
#
# Stage Pのtarget-free surfaceを読み、outer-valid fold 2を完全holdoutして2 branchの
...
print("Stage M outer fold 2 COMPLETE. Inference and submission were not generated.")
