# %% [markdown]
# # exp497 Stage M — outer fold 1
#
# Stage Pのtarget-free surfaceを読み、outer-valid fold 1を完全holdoutして2 branchの
...
print("Stage M outer fold 1 COMPLETE. Inference and submission were not generated.")
