...
OUTPUT_PREFIX = "exp190_denoised_calibrated_matching_features_on_exp148"
...
def build_sp45_bimodal_selector_features(
    ...
    raise NotImplementedError(
        "exp190 does not implement the legacy sp45 inference feature wrapper. "
...
def run_denoised_calibrated_matching_features_on_exp148(
    *,
    output_dir: str | Path,
    train_dir: str | Path,
    cache_path: str | Path | None = None,
    ...
    manifest = {
        "experiment": "exp190_denoised_calibrated_matching_features_on_exp148",
        ...
        "mode": "denoised_calibrated_matching_features_on_exp148_full_train_rows",
