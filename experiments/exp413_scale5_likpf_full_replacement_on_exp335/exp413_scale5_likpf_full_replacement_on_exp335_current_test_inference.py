...
# %% [markdown]
# # exp413 scale5 likelihood-PF full-replacement CPU inference
#
...
# modelsをSHA検証してCPU適用する。学習、hard selector、Viterbi、
# submission.csv生成、competition submitは行わない。
...
# 7. Prediction-only artifacts and reproducibility manifest
