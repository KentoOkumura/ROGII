...
# %% [markdown]
# # exp204_heatmap_mdn_topk_as_selector_candidates_on_exp158 inference
#
...
# %%
print(
    "No inference flow is implemented for exp204. "
    "Run the train notebook first and review global OOF, path switch, worst-well, "
    "near-row, distance bucket, heatmap candidate selection rate, hmpf/hmdn confidence buckets, "
    "and exp115 subgroup metrics "
