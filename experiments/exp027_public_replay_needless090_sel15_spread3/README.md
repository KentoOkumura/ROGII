...
- Submit ID: 53420592
- 作成日: 2026-06-06
- 親実験: `needless090/lb8-781-rogii-sel15-spread3`
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp027_public_replay_needless090_sel15_spread3_train.ipynb`
- 推論 notebook: `exp027_public_replay_needless090_sel15_spread3_inference.ipynb`
