...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp023_pseudo_tail_distance_augmentation_train.ipynb`
- 推論 notebook: `exp023_pseudo_tail_distance_augmentation_inference.ipynb`
