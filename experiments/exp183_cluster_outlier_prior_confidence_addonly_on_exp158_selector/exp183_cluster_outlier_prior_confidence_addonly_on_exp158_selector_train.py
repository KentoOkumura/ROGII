...
# %% [markdown]
# # exp183_cluster_outlier_prior_confidence_addonly_on_exp158_selector train
#
# Add-only cluster-outlier prior confidence features for the exp157/158 PF/Beam
# candidate selector. The exp181 prior corrections are used as score features
# only; no direct correction is applied to predictions.
...
# 4. Train add-only selector scores and Viterbi continuity variants
...
from cluster_outlier_prior_confidence_addonly_on_exp158_selector import (
    run_cluster_outlier_prior_confidence_addonly_on_exp158_selector,
)
...
print("Prior parent:", get_nested(config, "lineage.prior_parent"))
...
# %%
summary = run_cluster_outlier_prior_confidence_addonly_on_exp158_selector(
