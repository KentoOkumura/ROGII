...
# %% [markdown]
# # exp183_cluster_outlier_prior_confidence_addonly_on_exp158_selector inference
#
# This experiment is a train-side selector audit only. It does not create a
# submission candidate or apply exp181 corrections directly.
...
# %%
print(
    "No inference flow is implemented for exp183. "
    "Run the train notebook first and review global OOF, path switch, worst-well, "
    "distance bucket, and exp115 subgroup metrics before considering any follow-up."
)
