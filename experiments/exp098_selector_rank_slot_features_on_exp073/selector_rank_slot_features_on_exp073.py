...
OUTPUT_PREFIX = "exp098_selector_rank_slot_features_on_exp073"
...
def run_selector_rank_slot_features_on_exp073(
    *,
    output_dir: str | Path,
    train_dir: str | Path,
    cache_path: str | Path | None = None,
...
def run_saved_model_inference(
    *,
    ...
    summary = {
        ...
        "known_followup_risk": (
            "Inference was requested by the user even though exp098 train-side OOF is weaker "
...
run_u_projection_feature_ablation = run_selector_rank_slot_features_on_exp073
