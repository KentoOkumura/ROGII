...
OUTPUT_PREFIX = "exp224_well_scaled_z_dz_features_on_exp218"
...
def build_sp45_bimodal_selector_features(
    ...
    raise NotImplementedError(
        "exp224 does not implement the legacy sp45 inference feature wrapper. "
...
def run_well_scaled_z_dz_features_on_exp218(
    *,
    output_dir: str | Path,
    train_dir: str | Path,
    cache_path: str | Path | None = None,
    ...
    manifest = {
        "experiment": "exp224_well_scaled_z_dz_features_on_exp218",
        ...
        "mode": "well_scaled_z_dz_features_on_exp218_full_train_rows",
...
def run_saved_model_inference(
    *,
    ...
    grwr_feature_config: dict[str, Any] | None = None,
    well_scaled_feature_config: dict[str, Any] | None = None,
    variant_name: str = "well_scaled_z_dz_addonly",
