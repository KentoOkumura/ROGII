...
# %% [markdown]
# # exp224_well_scaled_z_dz_features_on_exp218 train lgb0
#
# CPU split training for LightGBM config `lgb0` only.
...
from well_scaled_z_dz_features_on_exp218 import (
    EXP145_TRAIN_ML_FEATURES,
    FULL_REPLAY_TRAIN_FEATURES,
    OUTPUT_PREFIX,
    find_artifact,
    run_well_scaled_z_dz_features_on_exp218,
)
...
# %%
summary = run_well_scaled_z_dz_features_on_exp218(
