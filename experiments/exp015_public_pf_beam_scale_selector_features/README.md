# exp015_public_pf_beam_scale_selector_features
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp015_public_pf_beam_scale_selector_features_train.ipynb`
- 推論 notebook: `exp015_public_pf_beam_scale_selector_features_inference.ipynb`
