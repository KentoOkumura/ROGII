...
# %% [markdown]
# # exp218_gr_wavelet_rotation_confidence_features_on_exp148 inference
#
# Saved-booster inference for the exp148 add-only LightGBM surface with
# target-free GR wavelet / FFT rotation-denoise confidence features. This
# regenerates current-test replay, learned likelihood, and GRWR features, then
# loads the exp218 train v1 boosters.
...
from gr_wavelet_rotation_confidence_features_on_exp148 import run_saved_model_inference
...
selected_variant = cfg_get(
    ...
    "gr_wavelet_rotation_confidence_addonly",
)
...
print("Train kernel source:", "kentookumura/exp218-gr-wavelet-rotation-exp148-train")
