...
- ルート: pf_beam
- 状態: all-well cutoff 0.65 artifact completed
- CV: -
- Public LB: -
- Private LB: -
- Submit ID: -
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp029_public_sel15_pf_oof_feature_generation_train.ipynb`
- 推論 notebook: `exp029_public_sel15_pf_oof_feature_generation_inference.ipynb`
