...
class CFG:
    ...
    HARD_WINDOW_NAME = "pct50"
    HARD_WINDOW_ENABLED = True
    HARD_WINDOW_MIN_PCT = 0.50
...
PUBLIC_SOURCE_PROVENANCE = {
    ...
    "note": "The base feature builder is the public Ravaghi-style builder copied inside the Pixiux notebook; this experiment rebuilds it from raw files after cutting each typewell to typewell_pct >= 0.50 before PF/Beam/likelihood-PF generation.",
}
...
def feature_columns_for_variant(df: pd.DataFrame, variant: str) -> list[str]:
    ...
    if variant in {"pixiux_likpf_public_replay", "pixiux_likpf_hard_window_pct50_public_replay"}:
