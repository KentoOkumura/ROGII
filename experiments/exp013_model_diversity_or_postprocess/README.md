# exp013_model_diversity_or_postprocess
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp013_model_diversity_or_postprocess_train.ipynb`
- 推論 notebook: `exp013_model_diversity_or_postprocess_inference.ipynb`
