...
# %% [markdown]
# # exp217_grcal_public_raw_pf_confidence_features_on_exp158 inference
#
# This experiment is a train-side selector audit only. It does not create a
# submission candidate, direct pubraw PF replacement, blend, or PF-weight
# replacement.
...
# %%
print(
    "No inference flow is implemented for exp217. "
    "Run the train notebook first and review global OOF, path switch, worst-well, "
    "near-row, distance bucket, public raw PF confidence bucket, and exp115 subgroup metrics "
