...
def run_rawtest_inference(*, config: dict[str, Any], paths: ExperimentPaths) -> dict[str, Any]:
    ...
    summary = {
        ...
        "notes": [
            ...
            (
                "exp109/exp114 OOF-only cluster/prior confidence features have no raw-test "
                "parity artifact; absent long features use raw-test median imputation "
                "(all-missing columns use zero) and are reported above."
            ),
            (
