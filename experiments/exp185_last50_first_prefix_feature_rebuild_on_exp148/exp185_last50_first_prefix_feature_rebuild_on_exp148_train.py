...
# %% [markdown]
# # exp185_last50_first_prefix_feature_rebuild_on_exp148 train
#
# Kaggle GPU LightGBM audit for last50-first rebuilt prefix features on top of exp148.
#
...
# 3. Train last50-first prefix rebuild variants
...
from last50_first_prefix_feature_rebuild_on_exp148 import (
    ...
    run_last50_first_prefix_feature_rebuild_on_exp148,
)
...
# %% [markdown]
# ## 3. Train last50-first prefix rebuild variant

# %%
summary = run_last50_first_prefix_feature_rebuild_on_exp148(
...
prefix_crop_summary = pd.read_csv(paths.artifacts_dir / f"{OUTPUT_PREFIX}_prefix_crop_feature_summary.csv")
...
display(prefix_crop_summary.head(30))
