...
# %% [markdown]
# # exp185_last50_first_prefix_feature_rebuild_on_exp148 inference
#
# Saved-booster inference for the last50-first prefix rebuild variant.
#
...
selected_variant = cfg_get(config, "inference.selected_variant", "last50_first_prefix_rebuild")
