...
# %% [markdown]
# # exp185_last50_first_prefix_feature_rebuild_on_exp148 train lgb0
#
# Kaggle CPU LightGBM split run for config `lgb0` only.
...
print("last50 prefix rebuild cache:", prefix_crop_path, "bytes=", prefix_crop_path.stat().st_size)
