...
# %% [markdown]
# # exp421 signed segment-rate numerical contract — Stage 1
#
# This successor leaves exp418's technical FAIL unchanged. Before training, it
# verifies the exact exp418 Stage 0 summary and a truth-free float64 integration
# audit against the preregistered 1e-10 ft numerical contract.
#
# The signed K16 target, saved exp333 strict-nested exp226 predictions, folds,
# target-free 136-feature surface, fixed LightGBM config, and every scientific
# gate remain unchanged. This notebook runs Stage 1 only, never fits or
# regenerates exp226, and keeps inference and submission fail-closed.
...
# 7. Inherited Stage 0 and numerical-contract eligibility
...
EXPERIMENT_NAME = "exp421_signed_segment_rate_numerical_contract_stage1"
...
EXECUTE_NOTEBOOK = (
    os.environ.get("EXP421_IMPORT_ONLY", "0") != "1" and in_notebook_runtime()
)
...
def load_config() -> dict[str, Any]:
    ...
    for path in candidates:
        if path.is_file():
            ...
            return value
    raise FileNotFoundError("exp421 config.yaml was not found")
...
def validate_implementation_contract(
    ...
    exact = {
        ...
        "implementation.scope": "stage_1_only_after_exp418_numerical_eligibility",
        "implementation.stage_0_enabled": False,
        ...
        "numerical_contract.dtype": "float64",
        "numerical_contract.maximum_matrix_vs_sequential_integration_abs_ft": 1e-10,
        "numerical_contract.synthetic_audit.truth_columns_loaded": 0,
        "data.parent_exp418_stage0.expected_summary_file_sha256": (
            "07c719e0f174b1712650563620f6331504dbd1333969c8777f41ce46419dc412"
        ),
        "data.parent_exp418_stage0.expected_decision": "FAIL_CLOSE_BRANCH",
        "data.parent_exp418_stage0.expected_status": "technical_fail",
        "data.parent_exp418_stage0.expected_rate_target_content_sha256": (
            "5c936b03e86e7250afdfef551e796e0beead22d50715d025b84acb9b13a9e2ff"
        ),
        "data.exp228_reference.expected_source_file_sha256": (
            "8cf163688daa8a6ed4cf4d9169b66b039a04d167df4d45ac881335bb5ee6e155"
        ),
        "data.exp072_feature_cache.expected_file_sha256": (
            "14faee3a24de587b7190e7febffd33cc1256e418c7505f2d1e6f5f7c9b3c2f18"
        ),
        "data.exp072_feature_cache.expected_decompressed_sha256": (
            "99a3c70a19b2f22a8c76c5947b14692e7b8207ea45f38b8b1c5f327d320e1350"
        ),
        "data.exp072_feature_cache.expected_schema_file_sha256": (
            "700d38149f583c3ab6574ea7b163c3c8709c2514b675bea381d822f82f4809b8"
        ),
        "data.exp333_stage1.expected_projection_summary_file_sha256": (
            "07918f74b34495ee3132bb6f0846ff35ec6e407ba1f2a8be1f7d0dc3fa14e4c9"
        ),
        "data.exp333_stage1.expected_grwr_summary_file_sha256": (
            "176938bc5d5301a7c0f599ce77a8be855569a3d4dacce5207c660aea25c7ff57"
        ),
        "data.exp333_stage1.expected_row_feature_content_sha256": (
            "d8e9320cfb6fce9f51b277b2fcb19380b9dbbb3f08fd53c5ba35308e1b5b3048"
        ),
        "data.exp333_stage1.expected_feature_freeze_sha256": (
            "13dd89dc9d438e190b9d781bbd1fdf2c919329f2bf3f59436b917e6d1690db28"
        ),
        "data.exp333_stage1.expected_fold_manifest_content_sha256": (
            "e857a778a6fb248ad4f4988886806fb370f01afbdccfa1d5d0cb790c732a0604"
        ),
        "data.exp333_stage1.expected_segment_assignment_content_sha256": (
            "29ecc2a5bbfa8b3982c9c2852d816a1e985015274bcff5e97d6c7028b49717a1"
        ),
        "data.exp333_stage1.expected_nested_exp226_prediction_content_sha256": (
            "8140e7ad165eacb0234e2ccd034d725f1b74273dc284a97d42a32401728188bc"
        ),
        "data.exp333_stage1.expected_outer_valid_parent_parity_max_abs_ft": (
            1.8189894035458565e-12
        ),
        "stage_1_gate.maximum_pooled_rmse": 8.89408550082682,
        "stage_1_gate.minimum_gain_vs_exp228_ft": 0.05,
        "stage_1_gate.minimum_gain_vs_exp333_ft": 0.05,
        "stage_1_gate.minimum_improved_folds_vs_exp226": 4,
        "stage_1_gate.maximum_near_0_250_delta_vs_exp226_ft": 0.0,
        "stage_1_gate.maximum_1000_plus_delta_vs_exp226_ft": 0.0,
        "stage_1_gate.maximum_hidden_spatial_delta_vs_exp226_ft": 0.0,
        "stage_1_gate.maximum_hidden_typewell_purged_delta_vs_exp226_ft": 0.0,
        "stage_1_gate.maximum_boundary_pm8_delta_vs_exp226_ft": 0.0,
        "stage_1_gate.maximum_by_well_p95_delta_vs_exp226_ft": 0.0,
        "stage_1_gate.maximum_worst_well_delta_vs_exp226_ft": 0.25,
        "stage_1_gate.required_rate_target_rmse_improved_folds_vs_zero": 5,
        "stage_1_gate.minimum_rate_sign_balanced_accuracy": 0.5,
        "stage_1_gate.required_rate_sign_balanced_accuracy_folds": 4,
        "stage_1_gate.maximum_first_row_correction_abs_ft": 1e-12,
        "stage_1_gate.maximum_matrix_vs_sequential_integration_abs_ft": 1e-10,
        "execution_contract.implementation_approved": True,
        "execution_contract.stage_0.boosters": 0,
        "execution_contract.stage_1.boosters": 5,
        "execution_contract.stage_1.exp226_fits": 0,
        "execution_contract.stage_1.parent_control_retraining": False,
        "execution_contract.feature_sha_debug.boosters": 0,
        "execution_contract.feature_sha_debug.truth_columns_loaded": 0,
        "execution_contract.frozen_input_sha_debug.boosters": 0,
        "execution_contract.frozen_input_sha_debug.truth_columns_loaded": 0,
        "execution_contract.frozen_input_sha_debug.feature_surface_regeneration": 0,
    ...
    if changed:
        raise ValueError(f"exp421 frozen implementation contract changed: {changed}")
    if tuple(get_nested(config, "features.row_groups", ())) != ALLOWED_FEATURE_GROUPS:
        raise ValueError("exp421 feature group allowlist changed")
    if tuple(get_nested(config, "features.structural_columns", ())) != (
        STRUCTURAL_FEATURE_COLUMNS
    ):
        raise ValueError("exp421 structural feature contract changed")
    if tuple(get_nested(config, "model.active_variants", ())) != (
        "signed_k16_rate",
    ):
        raise ValueError("exp421 must contain one signed-rate variant")
    if tuple(
        get_nested(
            config,
            "data.parent_exp418_stage0.expected_failed_technical_checks",
            (),
        )
    ) != ("integration_parity",):
        raise ValueError("exp421 parent-failure identity changed")
    if tuple(
        get_nested(config, "numerical_contract.synthetic_audit.suffix_lengths", ())
    ) != (1, 2, 17, 257, 4097):
        raise ValueError("exp421 synthetic numerical audit cases changed")
    if execution_stage is not None:
        ...
        approval_key = {
            ...
            "feature_sha_debug": (
                "execution_contract.feature_sha_debug_run_approved"
            ),
            "frozen_input_sha_debug": (
                "execution_contract.frozen_input_sha_debug_run_approved"
            ),
        }.get(execution_stage)
    ...
    return {
        ...
        "feature_sha_debug_run_approved": bool(
            get_nested(
                config,
                "execution_contract.feature_sha_debug_run_approved",
            )
        ),
        "frozen_input_sha_debug_run_approved": bool(
            get_nested(
                config,
                "execution_contract.frozen_input_sha_debug_run_approved",
            )
...
def load_frozen_exp333_feature_schema_only(
    config: Mapping[str, Any],
) -> tuple[pd.DataFrame, dict[str, Any]]:
    """Load only the target-free feature schema needed by the SHA diagnostic."""
    spec = get_nested(config, "data.exp333_stage1")
    sha_path = resolve_existing(
        str(spec["sha_manifest_filename"]), spec["sha_manifest_patterns"]
    )
    manifest_sha = sha256_file(sha_path)
    if manifest_sha != str(spec["expected_sha_manifest_file_sha256"]):
        raise ValueError("saved exp333 SHA manifest is not the frozen version")
    manifest = pd.read_csv(sha_path)
    if not {"filename", "file_sha256"}.issubset(manifest.columns):
        raise ValueError("saved exp333 SHA manifest schema is incomplete")
    ...
    if tuple(feature_schema.columns) != expected_columns:
        raise ValueError("saved exp333 feature schema columns changed")
    if len(feature_schema) != int(spec["expected_feature_count"]):
        raise ValueError("saved exp333 feature count changed")
    content_sha = hashed_frame_sha256(feature_schema, expected_columns)
    if content_sha != str(spec["expected_feature_schema_content_sha256"]):
        raise ValueError("saved exp333 feature-schema content SHA mismatch")
    return feature_schema, {
        ...
        "nested_prediction_loaded": False,
        "fold_manifest_loaded": False,
        "truth_or_error_columns_loaded": 0,
        "exp226_fits": 0,
    }
...
def exact_k16_segment_ids(length: int, k_segments: int = K_SEGMENTS) -> np.ndarray:
    ...
    if k_segments != K_SEGMENTS:
        raise ValueError("exp421 is fixed to K16")
...
def cumulative_rate_basis(
    ...
    if k_segments != K_SEGMENTS:
        raise ValueError("exp421 cumulative basis is fixed to K16")
...
def integrate_segment_rates_sequential(
    ...
    if rate.shape != (K_SEGMENTS,):
        raise ValueError("exp421 requires exactly 16 predicted rates")
...
def run_truth_free_numerical_audit(
    config: Mapping[str, Any],
) -> dict[str, Any]:
    spec = get_nested(config, "numerical_contract")
    audit = spec["synthetic_audit"]
    if int(audit["truth_columns_loaded"]) != 0:
        raise ValueError("synthetic numerical audit must remain truth-free")
    rates = np.linspace(
        float(audit["rate_min_ft_per_row"]),
        float(audit["rate_max_ft_per_row"]),
        K_SEGMENTS,
        dtype=np.float64,
    )
    perturbation = float(audit["alternating_perturbation_ft_per_row"])
    rates = rates + perturbation * np.where(
        np.arange(K_SEGMENTS, dtype=np.int64) % 2 == 0,
        1.0,
        -1.0,
    )
    records: list[dict[str, Any]] = []
    for length_value in audit["suffix_lengths"]:
        length = int(length_value)
        segment = exact_k16_segment_ids(length)
        matrix, max_abs = integrate_predicted_rates(segment, rates)
        records.append(
            {
                "suffix_length": length,
                "finite": bool(np.isfinite(matrix).all()),
                "first_row_correction_abs_ft": float(abs(matrix[0])),
                "matrix_vs_sequential_integration_abs_max_ft": max_abs,
            }
        )
    maximum = max(
        float(record["matrix_vs_sequential_integration_abs_max_ft"])
        for record in records
    )
    threshold = float(
        spec["maximum_matrix_vs_sequential_integration_abs_ft"]
    )
    passed = (
        all(bool(record["finite"]) for record in records)
        and max(
            float(record["first_row_correction_abs_ft"]) for record in records
        )
        == 0.0
    ...
    evidence = {
        ...
        "rate_vector": [float(value) for value in rates],
        "cases": records,
        "observed_max_abs_ft": maximum,
        "required_max_abs_ft": threshold,
        "pass": passed,
    }
    evidence["contract_sha256"] = mapping_sha256(evidence)
    if not passed:
        raise RuntimeError("truth-free numerical integration audit failed")
    return evidence


def rate_basis_content_sha256(rows: pd.DataFrame) -> str:
    digest = hashlib.sha256(b"exp421|zero_intercept_k16_rate_basis|float64|v1")
...
def load_feature_source() -> Any:
    try:
        ...
        spec = importlib.util.spec_from_file_location("exp421_exp228_source", local)
...
def build_feature_surface(
    ...
    *,
    ...
    if forbidden:
        raise ValueError(f"forbidden exp421 model features: {forbidden}")
    ...
    if enforce_expected_sha and metadata["row_feature_content_sha256"] != expected_row_sha:
        raise ValueError(
            "reconstructed exp333 row-feature content SHA mismatch: "
            f"actual={metadata['row_feature_content_sha256']} "
            f"expected={expected_row_sha}"
        )
...
def save_feature_importance_plot(importance: pd.DataFrame, path: Path) -> None:
    ...
    axis.set_title("exp421 mean LightGBM gain importance (top 30)")
...
def load_parent_exp418_eligibility(config: Mapping[str, Any]) -> dict[str, Any]:
    numerical_evidence = run_truth_free_numerical_audit(config)
    spec = get_nested(config, "data.parent_exp418_stage0")
    expected_sha = spec.get("expected_summary_file_sha256")
    if not isinstance(expected_sha, str) or len(expected_sha) != 64:
        raise RuntimeError(
            "exp421 requires the exact exp418 Stage 0 summary SHA in config"
        )
    path = resolve_existing(str(spec["filename"]), spec["patterns"])
    if sha256_file(path) != expected_sha:
        raise ValueError("frozen exp418 Stage 0 summary file SHA mismatch")
    summary = json.loads(path.read_text())
    if summary.get("experiment") != str(spec["source"]):
        raise ValueError("exp418 Stage 0 summary experiment identity changed")
    if summary.get("status") != str(spec["expected_status"]):
        raise RuntimeError("exp418 Stage 0 status changed")
    if summary.get("decision") != str(spec["expected_decision"]):
        raise RuntimeError("exp418 Stage 0 decision changed")
    if bool(summary.get("technical_pass")) or bool(summary.get("scientific_pass")):
        raise RuntimeError("exp418 must remain classified as technical FAIL")
    technical_checks = {
        str(key): bool(value)
        for key, value in dict(summary.get("technical_checks", {})).items()
    }
    failed = sorted(key for key, value in technical_checks.items() if not value)
    expected_failed = sorted(
        str(value) for value in spec["expected_failed_technical_checks"]
    )
    if failed != expected_failed:
        raise RuntimeError("exp418 technical failure identity changed")
    passed_count = sum(bool(value) for value in technical_checks.values())
    if passed_count != int(spec["expected_passed_technical_checks"]):
        raise RuntimeError("exp418 passed technical-check count changed")
    scientific_checks = {
        str(key): bool(value)
        for key, value in dict(summary.get("scientific_checks", {})).items()
    }
    if scientific_checks != dict(spec["expected_scientific_checks"]):
        raise RuntimeError("exp418 scientific threshold evidence changed")
    observed = float(
        summary["diagnostics"][
            "matrix_vs_sequential_integration_abs_max_ft"
        ]
    )
    if observed != float(spec["expected_observed_integration_abs_max_ft"]):
        raise RuntimeError("exp418 integration diagnostic changed")
    threshold = float(
        get_nested(
            config,
            "numerical_contract.maximum_matrix_vs_sequential_integration_abs_ft",
        )
    )
    if observed > threshold:
        raise RuntimeError("exp418 exceeds the exp421 numerical contract")
    if summary.get("rate_target_sha256") != str(
        spec["expected_rate_target_content_sha256"]
    ):
        raise RuntimeError("exp418 rate-target content SHA changed")
    return {
        "path": str(path),
        "file_sha256": expected_sha,
        "decision": summary["decision"],
        "status": summary["status"],
        "exp418_reclassified": False,
        "failed_technical_checks": failed,
        "passed_technical_checks": passed_count,
        "scientific_threshold_checks": scientific_checks,
        "observed_integration_abs_max_ft": observed,
        "accepted_numerical_max_abs_ft": threshold,
        "rate_target_sha256": summary["rate_target_sha256"],
        "truth_free_numerical_audit": numerical_evidence,
    }


def run_feature_sha_debug(config: Mapping[str, Any]) -> dict[str, Any]:
    """Rebuild only the target-free feature surface and persist SHA diagnostics."""
    validate_implementation_contract(config, execution_stage="feature_sha_debug")
    parent_eligibility = load_parent_exp418_eligibility(config)
    artifacts = output_artifacts_dir()
    artifacts.mkdir(parents=True, exist_ok=True)
    frozen_schema, schema_evidence = load_frozen_exp333_feature_schema_only(config)
    train_dir = resolve_train_dir()
    feature_source = load_feature_source()
    source_spec = getattr(feature_source, "__spec__", None)
    source_origin = getattr(source_spec, "origin", None)
    if not source_origin or not Path(source_origin).is_file():
        raise RuntimeError("could not resolve the frozen exp228 feature source path")
    source_path = Path(source_origin)
    source_sha = sha256_file(source_path)
    expected_source_sha = str(
        get_nested(config, "data.exp228_reference.expected_source_file_sha256")
    )
    ...
    row_columns = ("well_id", "row_idx", "md_since", *surface.feature_columns)
    sorted_row_sha = hashed_frame_sha256(surface.frame, row_columns)
    group_hashes: dict[str, dict[str, Any]] = {}
    for group in ALLOWED_FEATURE_GROUPS:
        group_columns = tuple(
            frozen_schema.loc[
                frozen_schema["source_group"].eq(group), "feature_name"
            ].astype(str)
        )
        group_hashes[group] = {
            "feature_count": len(group_columns),
            "sorted_row_content_sha256": hashed_frame_sha256(
                surface.frame,
                ("well_id", "row_idx", "md_since", *group_columns),
            ),
        }

    paths = {
        "schema": artifacts / f"{OUTPUT_PREFIX}_feature_sha_debug_schema.csv",
        "projection": artifacts
        / f"{OUTPUT_PREFIX}_feature_sha_debug_projection_summary.csv",
        "grwr": artifacts / f"{OUTPUT_PREFIX}_feature_sha_debug_grwr_summary.csv",
        "summary": artifacts / f"{OUTPUT_PREFIX}_feature_sha_debug_summary.json",
    }
    write_csv(paths["schema"], surface.schema)
    write_csv(paths["projection"], surface.projection_summary)
    write_csv(paths["grwr"], surface.grwr_summary)

    cache = dict(surface.metadata["cache"])
    cache_expected = {
        "file_sha256": str(
            get_nested(config, "data.exp072_feature_cache.expected_file_sha256")
        ),
    ...
    cache_checks = {
        key: {
            ...
            "expected": expected,
            "match": cache.get(key) == expected,
        }
        for key, expected in cache_expected.items()
    }
    generated_summary_checks = {
        "projection_summary": {
            "actual": sha256_file(paths["projection"]),
            "expected": str(
                get_nested(
                    config,
                    "data.exp333_stage1.expected_projection_summary_file_sha256",
    ...
    for item in generated_summary_checks.values():
        item["match"] = item["actual"] == item["expected"]
    expected_row_sha = str(
        get_nested(config, "data.exp333_stage1.expected_row_feature_content_sha256")
    )
    actual_row_sha = str(surface.metadata["row_feature_content_sha256"])
    reproduction_checks = {
        "feature_source": {
            "actual": source_sha,
            "expected": expected_source_sha,
            "match": source_sha == expected_source_sha,
        },
        "cache": cache_checks,
        "generated_summaries": generated_summary_checks,
        "row_feature_content": {
            "actual_unsorted": actual_row_sha,
            "actual_sorted": sorted_row_sha,
            "expected": expected_row_sha,
            "unsorted_match": actual_row_sha == expected_row_sha,
            "sorted_match": sorted_row_sha == expected_row_sha,
            "order_changes_hash": actual_row_sha != sorted_row_sha,
        },
    }
    all_exact = (
        reproduction_checks["feature_source"]["match"]
        and all(item["match"] for item in cache_checks.values())
        and all(item["match"] for item in generated_summary_checks.values())
        and actual_row_sha == expected_row_sha
    )
    summary = {
        "experiment": EXPERIMENT_NAME,
        "stage": "feature_sha_debug",
        "status": "completed",
        "all_frozen_feature_artifacts_exact": all_exact,
        "reproduction_checks": reproduction_checks,
        "row_feature_group_hashes": group_hashes,
        "row_order": {
            "rows": len(surface.frame),
            "wells": int(surface.frame["well_id"].nunique()),
            "first_key": surface.frame.loc[0, list(KEY_COLUMNS)].to_dict(),
            "last_key": surface.frame.loc[
                len(surface.frame) - 1, list(KEY_COLUMNS)
            ].to_dict(),
        },
        "feature_surface": surface.metadata,
        "exp333_schema_only_input": schema_evidence,
        "parent_exp418_stage0_eligibility": parent_eligibility,
        "execution": {
            "active_variants": 0,
            "model_configs": 0,
            "trained_folds": 0,
    ...
    manifest_path = artifacts / f"{OUTPUT_PREFIX}_feature_sha_debug_sha_manifest.csv"
    write_csv(
        manifest_path,
        pd.DataFrame(artifact_evidence(path) for path in paths.values()),
    )
    metrics_path = (
        KAGGLE_WORKING_ROOT / "metrics.json"
        if KAGGLE_WORKING_ROOT.exists()
        else experiment_dir() / "metrics.feature_sha_debug.runtime.json"
    )
    write_json(
        metrics_path,
        {
            "experiment": EXPERIMENT_NAME,
            "status": "feature_sha_debug_completed",
            "route": "ensemble",
            "cv": None,
            "feature_sha_debug": summary,
            "public_lb": None,
            "private_lb": None,
        },
    )
...
def run_frozen_input_sha_debug(config: Mapping[str, Any]) -> dict[str, Any]:
    """Hash saved nested/fold/exp226 inputs without features, truth, or models."""
    validate_implementation_contract(
        config, execution_stage="frozen_input_sha_debug"
    )
    parent_eligibility = load_parent_exp418_eligibility(config)
    artifacts = output_artifacts_dir()
    artifacts.mkdir(parents=True, exist_ok=True)
    ...
    parity = outer_valid_parent_parity(frozen.nested, saved_exp226)
    actual = {
        "fold_manifest_content_sha256": hashed_frame_sha256(
            frozen.fold_manifest,
            ("outer_fold", "well_id", "inner_fold", "inner_digest"),
        ),
        "segment_assignment_content_sha256": hashed_frame_sha256(
            frozen.nested,
            (
                "outer_fold",
                "role",
        ...
        "nested_exp226_prediction_content_sha256": hashed_frame_sha256(
            frozen.nested,
            (
                "outer_fold",
                "role",
    ...
    expected = {
        "fold_manifest_content_sha256": str(
            get_nested(
                config,
                "data.exp333_stage1.expected_fold_manifest_content_sha256",
            )
        ),
        "segment_assignment_content_sha256": str(
            get_nested(
                config,
                "data.exp333_stage1.expected_segment_assignment_content_sha256",
            )
        ),
        "nested_exp226_prediction_content_sha256": str(
            get_nested(
                config,
                (
                    "data.exp333_stage1."
                    "expected_nested_exp226_prediction_content_sha256"
                ),
            )
        ),
        "outer_valid_parent_parity_max_abs_ft": float(
            get_nested(
                config,
                (
                    "data.exp333_stage1."
                    "expected_outer_valid_parent_parity_max_abs_ft"
                ),
            )
        ),
    }
    ...
    summary = {
        "experiment": EXPERIMENT_NAME,
        "stage": "frozen_input_sha_debug",
        "status": "completed",
        "all_frozen_input_components_exact": all(
            item["match"] for item in checks.values()
        ),
        "checks": checks,
        "exp333_input_evidence": frozen.evidence,
        "exp226_input_evidence": exp226_evidence,
        "parent_exp418_stage0_eligibility": parent_eligibility,
        "execution": {
            "active_variants": 0,
            "model_configs": 0,
            ...
            "boosters": 0,
            "truth_columns_loaded": 0,
            "feature_surface_regeneration": 0,
            "exp226_fits": 0,
            "parent_control_retraining": False,
        },
        "inference_approved": False,
    ...
    summary_path = (
        artifacts / f"{OUTPUT_PREFIX}_frozen_input_sha_debug_summary.json"
    )
    write_json(summary_path, summary)
    metrics_path = (
        KAGGLE_WORKING_ROOT / "metrics.json"
        if KAGGLE_WORKING_ROOT.exists()
        else experiment_dir() / "metrics.frozen_input_sha_debug.runtime.json"
    )
    write_json(
        metrics_path,
        {
            "experiment": EXPERIMENT_NAME,
            "status": "frozen_input_sha_debug_completed",
            "route": "ensemble",
            "cv": None,
            "frozen_input_sha_debug": summary,
            "public_lb": None,
            "private_lb": None,
        },
    )
...
def run_stage1(config: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if len(model_features) != int(get_nested(config, "features.expected_feature_count")):
        raise ValueError("exp421 model feature count changed")
    ...
    if len(row_oof) != int(get_nested(config, "validation.expected_rows")):
        raise ValueError("exp421 OOF row coverage changed")
    if len(segment_oof) != int(get_nested(config, "validation.expected_segments")):
        raise ValueError("exp421 segment OOF coverage changed")
    ...
    summary = {
        ...
        "exp226_fits": 0,
        "parent_control_retraining": False,
        "parent_exp418_reclassified": False,
        "numerical_contract": parent_eligibility[
            "truth_free_numerical_audit"
        ],
        "inference_approved": False,
        "submission_approved": False,
    }
    ...
    json.dumps(
        {
            ...
            "stage1_variants": get_nested(
                CONFIG,
                "execution_contract.stage_1.active_variants",
            ),
            "stage1_model_configs": get_nested(
                CONFIG,
                "execution_contract.stage_1.model_configs",
            ),
            "stage1_folds": get_nested(
                CONFIG,
                "execution_contract.stage_1.outer_folds",
            ),
            "stage1_boosters": get_nested(
                CONFIG,
                "execution_contract.stage_1.boosters",
            ),
            "exp226_fits": get_nested(
                CONFIG,
                "execution_contract.stage_1.exp226_fits",
            ),
            "message": (
                "The saved nested/fold SHA diagnostic resolved the persisted "
                "serialization boundary. Approved Stage 1 is selected; "
                "inference and submission remain fail-closed."
            ),
        },
        indent=2,
        sort_keys=True,
...
if EXECUTE_NOTEBOOK:
    ...
    if SELECTED_STAGE == "stage_0":
        ...
        run_stage1(CONFIG)
    elif SELECTED_STAGE == "feature_sha_debug":
        run_feature_sha_debug(CONFIG)
    elif SELECTED_STAGE == "frozen_input_sha_debug":
        run_frozen_input_sha_debug(CONFIG)
    else:
        print("Implementation-only mode: no authorized execution was started.")
