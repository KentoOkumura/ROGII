...
# %% [markdown]
# # exp172_prefix_crop_last50_replacement_only_on_exp148 train
#
# CPU LightGBM replacement-only audit for last50 prefix crop features on top of exp148.
#
...
# 3. Train replacement-only prefix crop-window variants
...
from prefix_crop_last50_replacement_only_on_exp148 import (
    ...
    run_prefix_crop_last50_replacement_only_on_exp148,
)
...
# %% [markdown]
# ## 3. Train prefix crop-window feature variant

# %%
summary = run_prefix_crop_last50_replacement_only_on_exp148(
