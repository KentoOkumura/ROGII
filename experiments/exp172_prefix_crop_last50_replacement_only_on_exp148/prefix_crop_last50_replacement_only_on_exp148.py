...
OUTPUT_PREFIX = "exp172_prefix_crop_last50_replacement_only_on_exp148"
PREFIX_CROP_TRAIN_FEATURES = (
    "exp172_prefix_crop_last50_replacement_only_on_exp148_prefix_crop_train_features.csv.gz"
)
PREFIX_CROP_FEATURE_SCHEMA = (
    "exp172_prefix_crop_last50_replacement_only_on_exp148_prefix_crop_feature_schema.csv"
)
PREFIX_CROP_FEATURE_SUMMARY = (
    "exp172_prefix_crop_last50_replacement_only_on_exp148_prefix_crop_feature_summary.csv"
)
PREFIX_CROP_FEATURE_MANIFEST = (
    "exp172_prefix_crop_last50_replacement_only_on_exp148_prefix_crop_feature_manifest.json"
)
...
def _write_prefix_crop_feature_cache(
    *,
    ...
    manifest = {
        "experiment": "exp172_prefix_crop_last50_replacement_only_on_exp148",
...
def run_prefix_crop_last50_replacement_only_on_exp148(
    *,
    output_dir: str | Path,
    train_dir: str | Path,
    cache_path: str | Path | None = None,
    ...
    manifest = {
        ...
        "mode": "prefix_crop_last50_replacement_only_on_exp148_full_train_rows",
        "feature_source": feature_meta,
        "learned_likelihood_feature_source": learned_source_meta,
...
def run_saved_model_inference(
    *,
    ...
    learned_feature_config: dict[str, Any] | None = None,
    prefix_crop_config: dict[str, Any] | None = None,
    variant_name: str = "prefix_crop_last50_multiobs_replacement",
