...
# %% [markdown]
# # exp172_prefix_crop_last50_replacement_only_on_exp148 inference
#
# Saved-booster inference for the CPU prefix crop-window replacement-only variant.
#
...
selected_variant = cfg_get(config, "inference.selected_variant", "prefix_crop_last50_multiobs_replacement")
