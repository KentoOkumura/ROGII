# exp024_pseudo_tail_inference_postprocess

## 状態

- ルート: -
- 状態: inference completed
- CV: -
- Public LB: -
- Private LB: -
- Submit ID: -
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp024_pseudo_tail_inference_postprocess_train.ipynb`
- 推論 notebook: `exp024_pseudo_tail_inference_postprocess_inference.ipynb`
