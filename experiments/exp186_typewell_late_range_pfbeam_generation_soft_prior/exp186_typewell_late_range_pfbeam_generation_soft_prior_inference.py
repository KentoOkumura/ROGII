...
# ---
# %% [markdown]
# # exp186_typewell_late_range_pfbeam_generation_soft_prior inference
...
if inference_config.get("mode") != "not_applicable_train_feature_cache_only":
    raise ValueError("exp186 inference is intentionally disabled unless config is changed.")
...
print(
    ...
    "with the same soft-prior generation code."
)
