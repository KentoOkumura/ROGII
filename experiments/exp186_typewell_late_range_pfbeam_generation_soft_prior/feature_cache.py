...
import numpy as np
import pandas as pd
from late_soft_prior_public_replay import (
...
def run_train_feature_cache(
    *,
    ...
    summary = {
        "experiment": "exp186_typewell_late_range_pfbeam_generation_soft_prior",
        "status": "train_feature_cache_completed",
        "mode": "typewell_late_soft_prior_full_public_replay_train_feature_cache",
        "variant": VARIANT,
        "soft_prior": soft_prior,
        ...
        "notes": [
            ...
            "The selected soft prior is applied inside PF_ANCC, PF_Z, Beam, and likelihood-PF generation.",
