# exp025_pseudo_tail_postprocess_cv_audit
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp025_pseudo_tail_postprocess_cv_audit_train.ipynb`
- 推論 notebook: `exp025_pseudo_tail_postprocess_cv_audit_inference.ipynb`
