...
OUTPUT_PREFIX = "exp194_exp183_selector_confidence_replacement_only_on_exp148"
...
def run_exp183_selector_confidence_replacement_only_on_exp148(
    *,
    output_dir: str | Path,
    train_dir: str | Path,
    cache_path: str | Path | None = None,
    ...
    manifest = {
        ...
        "mode": "exp183_selector_confidence_replacement_only_on_exp148_full_train_rows",
