...
def run_joint_generation() -> dict[str, Any]:
    ...
    if bool(execution.get("run_direct_comparison", True)):
        ...
        comparison_summary = run_direct_comparison(
            ...
            baseline_source="in_memory_exp072_full_cache_generated_by_exp223" if use_in_memory_exp072 else None,
        )
    ...
    output_path = paths.artifacts_dir / "exp223_joint_typewell_self_gr_hmm_likelihood_probe_summary.json"
    summary = {
        "experiment": paths.experiment_name,
        "status": "joint_typewell_self_gr_hmm_likelihood_probe_completed_pending_review",
