...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp026_pseudo_tail_bucket_shrink_inference_submit_train.ipynb`
- 推論 notebook: `exp026_pseudo_tail_bucket_shrink_inference_submit_inference.ipynb`
