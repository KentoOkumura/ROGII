# exp018_candidate_distribution_router
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp018_candidate_distribution_router_train.ipynb`
- 推論 notebook: `exp018_candidate_distribution_router_inference.ipynb`
