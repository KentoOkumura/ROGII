# exp040_ravaghi_pf_ancc_pfz_feature_ablation
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp040_ravaghi_pf_ancc_pfz_feature_ablation_train.ipynb`
- 推論 notebook: `exp040_ravaghi_pf_ancc_pfz_feature_ablation_inference.ipynb`
