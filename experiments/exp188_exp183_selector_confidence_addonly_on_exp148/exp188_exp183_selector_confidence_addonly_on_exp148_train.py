...
# %% [markdown]
# # exp188_exp183_selector_confidence_addonly_on_exp148 train
#
# Full-train add-only feature audit for exp183 selector selected-path confidence features on top of the exp148 learned-likelihood LightGBM surface.
#
...
# 3. Train full-row exp183 selector add-only variant
...
from exp183_selector_confidence_addonly_on_exp148 import (
    EXP145_TRAIN_ML_FEATURES,
    EXP183_SELECTOR_OOF_PREDICTIONS,
    FULL_REPLAY_TRAIN_FEATURES,
    OUTPUT_PREFIX,
    find_artifact,
    run_exp183_selector_confidence_addonly_on_exp148,
)
...
# %% [markdown]
# ## 3. Train full-row control and learned-feature variants

# %%
summary = run_exp183_selector_confidence_addonly_on_exp148(
