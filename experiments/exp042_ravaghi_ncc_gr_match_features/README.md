# exp042_ravaghi_ncc_gr_match_features
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp042_ravaghi_ncc_gr_match_features_train.ipynb`
- 推論 notebook: `exp042_ravaghi_ncc_gr_match_features_inference.ipynb`
