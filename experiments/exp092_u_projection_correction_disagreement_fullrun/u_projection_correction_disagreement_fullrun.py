...
OUTPUT_PREFIX = "exp092_u_projection_correction_disagreement_fullrun"
...
def run_u_projection_correction_disagreement_fullrun(
    *,
    output_dir: str | Path,
    train_dir: str | Path,
    cache_path: str | Path | None = None,
    ...
    manifest = {
        ...
        "mode": "u_projection_correction_disagreement_fullrun_from_exp072_cache",
...
run_u_projection_feature_ablation = run_u_projection_correction_disagreement_fullrun
