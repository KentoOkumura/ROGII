# exp034_public_sel15_pf_meta_stack
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp034_public_sel15_pf_meta_stack_train.ipynb`
- 推論 notebook: `exp034_public_sel15_pf_meta_stack_inference.ipynb`
