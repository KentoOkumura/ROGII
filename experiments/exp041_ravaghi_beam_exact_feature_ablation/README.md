# exp041_ravaghi_beam_exact_feature_ablation
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp041_ravaghi_beam_exact_feature_ablation_train.ipynb`
- 推論 notebook: `exp041_ravaghi_beam_exact_feature_ablation_inference.ipynb`
