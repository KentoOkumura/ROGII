...
# %% [markdown]
# # exp180_learned_gr_window_matcher_features_on_exp148 train
#
# CPU LightGBM add-only audit for learned GR window matcher features on top of exp148.
#
...
# 3. Train learned GR window matcher feature variant
...
gr_matcher_summary = pd.read_csv(paths.artifacts_dir / f"{OUTPUT_PREFIX}_gr_matcher_feature_summary.csv")
...
display(gr_matcher_summary.head(30))
