...
# %% [markdown]
# # exp180_learned_gr_window_matcher_features_on_exp148 inference
#
# Saved-booster inference for the CPU learned GR window matcher add-only variant.
#
...
selected_variant = cfg_get(config, "inference.selected_variant", "learned_gr_window_matcher_addonly")
