...
# %% [markdown]
# # exp165_coordinate_frame_normalization_features_on_exp148 train_lgb0
#
# CPU split train runner for the `lgb0` LightGBM config. This writes a separate model manifest so inference can load `lgb0`, `lgb1`, and `lgb2` train outputs independently.
...
from coordinate_frame_normalization_features_on_exp148 import (
    OUTPUT_PREFIX,
    run_coordinate_frame_normalization_features_on_exp148,
)
from settings import EXPERIMENT_NAME, ExperimentPaths, get_nested, load_config


SPLIT_LGB_MODEL = "lgb0"
...
# %%
summary = run_coordinate_frame_normalization_features_on_exp148(
    ...
    coordinate_frame_config=cfg_get(config, "model.coordinate_frame", {}),
