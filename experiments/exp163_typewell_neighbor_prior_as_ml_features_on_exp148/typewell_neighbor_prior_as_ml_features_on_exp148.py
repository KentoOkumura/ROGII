...
EXPERIMENT_NAME = "exp163_typewell_neighbor_prior_as_ml_features_on_exp148"
...
def run_typewell_neighbor_prior_as_ml_features_on_exp148(
    *,
    output_dir: str | Path,
    train_dir: str | Path,
    cache_path: str | Path | None = None,
    ...
    learned_typewell_prior_config = learned_typewell_prior_config or {}
    ...
    if len(full_frame) != coverage_meta["joined_rows"]:
        raise ValueError(
            "Typewell neighbor prior features changed row coverage: "
    ...
    typewell_prior_summary.to_csv(
        output_dir / f"{output_prefix}_learned_typewell_prior_feature_summary.csv",
        index=False,
    )
    ...
    manifest = {
        ...
        "typewell_prior_source_parent": "exp109_typewell_neighbor_prior_features",
        "typewell_cluster_parent": "exp065_typewell_supertype_cluster_cv_audit",
        "typewell_candidate_parent": "exp099_pf_multi_observation_likelihood_probe",
        "mode": "typewell_neighbor_prior_as_ml_features_on_exp148_full_train_rows",
        ...
        "learned_typewell_prior_config": learned_typewell_prior_config,
    ...
    summary = {
        ...
        "artifacts": {
            ...
            "learned_typewell_prior_feature_summary": (
                f"{output_prefix}_learned_typewell_prior_feature_summary.csv"
            ),
