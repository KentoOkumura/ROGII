...
VARIANT = "crossfitted_residual_scale_emission_hmm"
...
def run_train_feature_cache(
    *,
    ...
    summary = {
        ...
        "mode": "crossfitted_residual_scale_emission_hmm_train_feature_cache",
        ...
        "notes": [
            ...
            "Saved exp218 OOF predictions are immutable Gaussian observation centers; only cross-fitted residual-scale sigma is row-wise.",
