# exp453_huber_exact_hmm_direct_public_lb_audit セッションノート

## 目的

tail guardで不採用となった固定Huber exact HMMを単体Public LBで記述評価する。
...
- 2026-07-30:
  `make new-steering EXP=exp453_huber_exact_hmm_direct_public_lb_audit`
- 2026-07-30:
  `make new-exp EXP=exp453_huber_exact_hmm_direct_public_lb_audit`
- 2026-07-30:
  exp389/209/434、`docs/06_reproducibility.md`を読み、候補、HMM状態空間、
...
- Gaussian / Student-t / PF / Beam runs: `0 / 0 / 0 / 0`
...
- Kaggle kernel id:
  `kentookumura/exp453-huber-exact-hmm-direct-lb-audit-inference`
