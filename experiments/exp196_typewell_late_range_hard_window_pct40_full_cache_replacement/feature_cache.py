...
def run_train_feature_cache(
    *,
    ...
    summary = {
        "experiment": "exp196_typewell_late_range_hard_window_pct40_full_cache_replacement",
        "status": "train_feature_cache_completed",
        "mode": "typewell_late_hard_window_pct40_full_public_replay_train_feature_cache",
        "variant": VARIANT,
        "hard_window": hard_window,
        ...
        "notes": [
            ...
            "Each typewell is filtered to typewell_pct >= 0.40 before PF_ANCC, PF_Z, Beam, and likelihood-PF generation.",
            "No typewell_pct 0.30/0.60/0.70 grid and no soft prior are run in this experiment.",
