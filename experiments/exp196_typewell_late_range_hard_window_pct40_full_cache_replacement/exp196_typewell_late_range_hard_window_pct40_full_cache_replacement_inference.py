...
# ---
# %% [markdown]
# # exp196_typewell_late_range_hard_window_pct40_full_cache_replacement inference
...
if inference_config.get("mode") != "not_applicable_train_feature_cache_only":
    raise ValueError("exp196 inference is intentionally disabled unless config is changed.")
...
print(
    ...
    "with the same typewell_pct >= 0.40 hard-window generation code."
)
