...
# ---
# %% [markdown]
# # exp233 mixture PF train — epsilon 0.02
#
# Full exp072-compatible likelihood-PF audit for `mix_eps_0p02` only. This
...
if [(spec.name, spec.epsilon) for spec in variants] != [("mix_eps_0p02", 0.02)]:
    raise RuntimeError("train_variant0 must execute only mix_eps_0p02.")
...
display(
    {
        ...
        "parallel_execution_note": "This kernel evaluates all eligible wells for epsilon=0.02 only; exp232 artifacts may be pending but are mandatory before acceptance.",
        "forbidden": [
