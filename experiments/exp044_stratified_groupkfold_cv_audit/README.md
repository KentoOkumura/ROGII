...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp044_stratified_groupkfold_cv_audit_train.ipynb`
- 推論 notebook: `exp044_stratified_groupkfold_cv_audit_inference.ipynb`
