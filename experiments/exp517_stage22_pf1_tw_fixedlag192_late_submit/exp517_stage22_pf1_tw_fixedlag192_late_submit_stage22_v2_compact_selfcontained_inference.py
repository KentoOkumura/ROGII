...
# %% [markdown]
# # exp517 stage 2-2 five-PF fixed-lag-192 tabular inference — corrected v2
#
...
# %% [markdown]
# ## 5. Orchestration
# Load the saved manifest, regenerate hidden-test features, and align to runtime sample IDs.
