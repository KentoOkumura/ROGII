...
# %% [markdown]
# # exp184_heatmap_selector_compact_addonly_on_exp148 train lgb0
#
# CPU LightGBM split run for config `lgb0` only.
...
print(json.dumps({
    ...
    "selected_lgb_config_indices": summary["selected_lgb_config_indices"],
