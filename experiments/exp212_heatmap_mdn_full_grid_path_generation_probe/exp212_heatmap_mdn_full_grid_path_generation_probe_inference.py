...
# %% [markdown]
# # exp212_heatmap_mdn_full_grid_path_generation_probe inference
#
# This experiment is train-side diagnostic only. It produces selector-facing
# full-grid heatmap MDN candidate path artifacts and does not create a
# submission.
...
scope = {
    ...
    "reason": (
        "exp212 is a train-side full-grid path artifact contract diagnostic. "
    ...
    "train_artifact": (
        "artifacts/exp212_heatmap_mdn_full_grid_path_generation_probe_"
        "localtopk10_full_grid_candidate_paths.csv.gz"
    ),
}
