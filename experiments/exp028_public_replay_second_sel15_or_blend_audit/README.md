...
- Submit ID: -
- 作成日: 2026-06-07
- 親実験: `needless090/lb-8-860-rogii-sel15-256seeds`

## 仮説

詳細な仮説は `SESSION_NOTES.md` と `result.md` を参照する。
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp028_public_replay_second_sel15_or_blend_audit_train.ipynb`
- 推論 notebook: `exp028_public_replay_second_sel15_or_blend_audit_inference.ipynb`
