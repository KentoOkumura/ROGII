...
# %% [markdown]
# # exp203_heatmap_mdn_candidates_into_selector_features train
#
# Add-only exp202 heatmap MDN topK candidate confidence features for the existing
# exp184 PF/Beam candidate selector. The selector candidate set stays fixed;
# heatmap MDN candidates are features only, with no direct replacement, softmax
# blend, PF-weight replacement, inference port, or submission candidate.
...
from heatmap_mdn_candidates_into_selector_features import (
    run_heatmap_mdn_candidates_into_selector_features,
)
...
# %%
summary = run_heatmap_mdn_candidates_into_selector_features(
