...
# %% [markdown]
# # exp203_heatmap_mdn_candidates_into_selector_features inference
#
...
# %%
print(
    "No inference flow is implemented for exp203. "
    "Run the train notebook first and review global OOF, path switch, worst-well, "
    "near-row, distance bucket, hmpf/hmdn confidence buckets, and exp115 subgroup metrics "
