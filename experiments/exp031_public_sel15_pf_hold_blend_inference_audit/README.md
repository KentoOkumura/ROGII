...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp031_public_sel15_pf_hold_blend_inference_audit_train.ipynb`
- 推論 notebook: `exp031_public_sel15_pf_hold_blend_inference_audit_inference.ipynb`
