...
# %% [markdown]
# # exp166_prefix_crop_midwindow_replacement_on_exp148 inference
#
...
selected_variant = cfg_get(config, "inference.selected_variant", "prefix_crop_tail1000_replacement")
