...
# %% [markdown]
# # exp166_prefix_crop_midwindow_replacement_on_exp148 train
#
# CPU LightGBM replacement-only audit for mid-window prefix crop features on top of exp148.
#
...
from prefix_crop_midwindow_replacement_on_exp148 import (
    ...
    run_prefix_crop_midwindow_replacement_on_exp148,
)
...
# %%
summary = run_prefix_crop_midwindow_replacement_on_exp148(
