...
DEFAULT_PATH_NPZ = f"{OUTPUT_PREFIX}_dense_candidate_paths_top10.npz"
DEFAULT_PATH_SAMPLES = f"{OUTPUT_PREFIX}_dense_path_samples.csv.gz"
...
def run_stitch_probe(
    *,
    ...
    summary = {
        ...
        "dense_path_generation": path_meta,
    ...
    experiment_metrics = {
        ...
        "notes": [
            (
                "This is a CPU diagnostic that regenerates dense stride local paths "
                "from saved exp202 fold models."
            ),
            (
