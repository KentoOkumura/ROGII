...
OUTPUT_PREFIX = "exp159_spatial_prior_confidence_features_on_exp092"
...
def run_spatial_prior_confidence_features_on_exp092(
    *,
    ...
    manifest = {
        "experiment": "exp159_spatial_prior_confidence_features_on_exp092",
...
def run_saved_model_inference(
    *,
    ...
    raise NotImplementedError(
        "exp159 is a train-side spatial prior confidence feature audit only. "
