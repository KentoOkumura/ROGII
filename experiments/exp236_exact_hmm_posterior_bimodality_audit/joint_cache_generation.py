...
def run_joint_generation() -> dict[str, Any]:
    ...
    if bool(execution.get("run_direct_comparison", True)):
        ...
        comparison_summary = run_direct_comparison(
            ...
            baseline_source="in_memory_exp072_full_cache_generated_by_exp221" if use_in_memory_exp072 else None,
        )
    ...
    output_path = paths.artifacts_dir / "exp221_lgb_oof_gaussian_emission_hmm_summary.json"
    summary = {
        "experiment": paths.experiment_name,
        "status": "lgb_oof_gaussian_emission_hmm_completed_pending_review",
