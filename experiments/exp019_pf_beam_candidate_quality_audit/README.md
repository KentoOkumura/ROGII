# exp019_pf_beam_candidate_quality_audit
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp019_pf_beam_candidate_quality_audit_train.ipynb`
- 推論 notebook: `exp019_pf_beam_candidate_quality_audit_inference.ipynb`
