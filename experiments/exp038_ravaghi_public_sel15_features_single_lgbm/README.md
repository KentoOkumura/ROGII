# exp038_ravaghi_public_sel15_features_single_lgbm
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp038_ravaghi_public_sel15_features_single_lgbm_train.ipynb`
- 推論 notebook: `exp038_ravaghi_public_sel15_features_single_lgbm_inference.ipynb`
