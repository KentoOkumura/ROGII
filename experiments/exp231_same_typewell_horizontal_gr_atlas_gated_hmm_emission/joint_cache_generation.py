...
def run_joint_generation() -> dict[str, Any]:
    ...
    if bool(execution.get("run_direct_comparison", True)):
        ...
        comparison_summary = run_direct_comparison(
            ...
            baseline_source="in_memory_exp072_full_cache_generated_by_exp231" if use_in_memory_exp072 else None,
        )
    ...
    output_path = paths.artifacts_dir / "exp231_peer_atlas_hmm_generation_summary.json"
    summary = {
