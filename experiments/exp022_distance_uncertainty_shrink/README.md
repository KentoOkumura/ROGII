# exp022_distance_uncertainty_shrink
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp022_distance_uncertainty_shrink_train.ipynb`
- 推論 notebook: `exp022_distance_uncertainty_shrink_inference.ipynb`
