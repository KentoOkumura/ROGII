# exp012_single_catboost_lightgbm_residual
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp012_single_catboost_lightgbm_residual_train.ipynb`
- 推論 notebook: `exp012_single_catboost_lightgbm_residual_inference.ipynb`
