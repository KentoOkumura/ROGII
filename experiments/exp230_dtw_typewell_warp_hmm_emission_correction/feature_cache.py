...
def main() -> dict[str, Any]:
    ...
    dtw_config = get_nested(config, "model.dtw_emission") or {}
    ...
    return run_train_feature_cache(
        ...
        output_prefix=str(feature_cache.get("output_prefix") or "exp230_dtw_typewell_warp_hmm_emission_correction"),
        max_wells=max_wells,
