# exp032_public_sel15_pf_residual_correction
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp032_public_sel15_pf_residual_correction_train.ipynb`
- 推論 notebook: `exp032_public_sel15_pf_residual_correction_inference.ipynb`
