...
EXPERIMENT_NAME = "exp105_compact_rank_slot_features_on_exp098"
OUTPUT_PREFIX = "exp105_compact_rank_slot_features_on_exp098"
...
def build_selector_rank_slot_features(
    ...
    *,
    ...
    for slot in range(top_k):
        ...
        group_columns["rank_slot_compact"].extend(
            [
    ...
    group_columns["rank_slot_compact"].extend(["rank_slot_u_std", "rank_slot_u_range"])
...
def run_compact_rank_slot_features_on_exp098(
    *,
    output_dir: str | Path,
    train_dir: str | Path,
    cache_path: str | Path | None = None,
    ...
    manifest = {
        ...
        "feature_parent": "exp098_selector_rank_slot_features_on_exp073",
        "cache_parent": "exp072_exp063_full_replay_feature_cache",
        "mode": "compact_rank_slot_features_from_exp098",
...
def run_saved_model_inference(
    *,
    ...
    summary = {
        ...
        "known_followup_risk": (
            "Inference was requested by the user even though exp105 train-side OOF is weaker "
            "than exp092; no competition submission decision has been made."
        ),
        "elapsed_seconds": round(time.time() - t0, 3),
    }
...
run_selector_rank_slot_features_on_exp073 = run_compact_rank_slot_features_on_exp098
run_u_projection_feature_ablation = run_compact_rank_slot_features_on_exp098
