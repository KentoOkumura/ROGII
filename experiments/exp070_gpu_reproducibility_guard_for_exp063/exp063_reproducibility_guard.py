...
OUTPUT_PREFIX = "exp063_repro_guard"
...
def run_reproducibility_guard(
    *,
    ...
    manifest = {
        "experiment": "exp070_gpu_reproducibility_guard_for_exp063",
        "parent": "exp063_ravaghi_vs_pixiux_lgbm_feature_parity_audit",
        "mode": "exp063_lgbm_reproducibility_guard_from_saved_tracker_features",
...
def run_saved_model_inference(
    *,
    ...
    summary = {
        ...
        "mode": "saved_lgb_booster_inference_from_exp070_train",
