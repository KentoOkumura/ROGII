# exp020_distance_weighted_training_audit
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp020_distance_weighted_training_audit_train.ipynb`
- 推論 notebook: `exp020_distance_weighted_training_audit_inference.ipynb`
