# exp011_tracker_divergence_features
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp011_tracker_divergence_features_train.ipynb`
- 推論 notebook: `exp011_tracker_divergence_features_inference.ipynb`
