...
import numpy as np
import pandas as pd
from step_delta_public_replay import (
...
OUTPUT_PREFIX = "exp200_pf_step_delta_soft_prior_full_replay_replacement_full_replay_cache"
...
def run_train_feature_cache(
    *,
    ...
    summary = {
        ...
        "mode": "pf_step_delta_soft_prior_full_public_replay_train_feature_cache",
        "variant": VARIANT,
        "step_delta_prior": step_delta_prior,
        ...
        "notes": [
            ...
            "The selected per-step TVT delta soft prior is applied inside PF_ANCC, PF_Z, and likelihood-PF particle weights.",
            "Beam search is intentionally left unchanged from the exp072 baseline generation.",
