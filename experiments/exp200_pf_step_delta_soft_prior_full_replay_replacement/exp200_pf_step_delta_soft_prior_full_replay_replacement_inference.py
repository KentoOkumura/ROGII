...
# ---
# %% [markdown]
# # exp200_pf_step_delta_soft_prior_full_replay_replacement inference
...
if inference_config.get("mode") != "not_applicable_train_feature_cache_only":
    raise ValueError("exp200 inference is intentionally disabled unless config is changed.")
...
print(
    ...
    "with the same step-delta-prior generation code."
)
