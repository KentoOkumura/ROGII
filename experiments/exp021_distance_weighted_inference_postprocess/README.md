...
- ルート: -
- 状態: implemented, pending Kaggle train/inference execution
- CV: -
- Public LB: -
- Private LB: -
- Submit ID: -
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp021_distance_weighted_inference_postprocess_train.ipynb`
- 推論 notebook: `exp021_distance_weighted_inference_postprocess_inference.ipynb`
