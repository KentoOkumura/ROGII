# exp036_test_time_prefix_calibration_audit
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp036_test_time_prefix_calibration_audit_train.ipynb`
- 推論 notebook: `exp036_test_time_prefix_calibration_audit_inference.ipynb`
