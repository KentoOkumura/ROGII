...
# %% [markdown]
# # exp228_direct_residual_correction_on_exp226 train_lgb1
#
# CPU split training for the `lgb1` LightGBM config. The feature surface matches exp218; the target is `TVT - exp226_oof_pred`.
...
SPLIT_KIND = "train_lgb1"
SELECTED_LGB_MODELS = ["lgb1"]
