...
```bash
.venv/bin/pytest -q experiments/exp305_tempered_raw_smoothed_exact_hmm_emission/tests/test_exp305_tempered_raw_smoothed_exact_hmm_emission.py
