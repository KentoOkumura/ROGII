# exp016_public_postprocess_ablation
...
- 結果: `result.md`
- メトリクス: `metrics.json`
- 学習 notebook: `exp016_public_postprocess_ablation_train.ipynb`
- 推論 notebook: `exp016_public_postprocess_ablation_inference.ipynb`
