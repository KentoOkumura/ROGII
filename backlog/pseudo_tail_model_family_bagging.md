# pseudo_tail_model_family_bagging

- 候補名: `pseudo_tail_model_family_bagging`
- 状態: `検討メモ・設計不可`
- 対応する上位仮説: `未整理`
- 作成日: 2026-08-12
- 最終更新日: 2026-08-12
...
- 移行前のアイデア: `pseudo_tail_model_family_bagging`: pseudo-tail 系の model family bagging を多様性診断として残す
- 仮説が正しい場合に期待する観測: 未整理
- 仮説を棄却する観測: 未整理
...
- 先行条件 / 依存: exp053 / exp061 以降の pseudo-tail artifacts。主戦場は exp073 / exp148 系
- 変更するもの: 未整理
- 固定するもの: 未整理
...
seed/model family の OOF 相関、bucket 別補完性、fixed blend の上限だけを確認する
